...
<main class="pt-90">
  <section class="shop-main container d-flex pt-4 pt-xl-5">
    ...
    <er class="shop-list flex-grow-1">
              ...
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products/thumbnails')}}/{{$image}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                    @endforeach
                  </div>
                </div>
