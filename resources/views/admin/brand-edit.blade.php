        ...
        <div class="wg-box">
            <form action="{{ route('admin.brand.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="form-field">
                    <div class="field-label">Brand Name <span>*</span></div>
                    <input type="text" name="name" value="{{ old('name', $brand->name) }}" required class="form-input"> @error('name')
                    <span class="alert alert-danger">{{ $message }}</span>
                    @enderror
                </fieldset>
                <fieldset class="form-field">
                    <div class="field-label">Brand Slug <span>*</span></div>
                    <input type="text" name="slug" value="{{ old('slug', $brand->slug) }}" required class="form-input"> @error('slug')
                    <span class="alert alert-danger">{{ $message }}</span>
                    @enderror
                </fieldset>
                <fieldset class="form-field">
